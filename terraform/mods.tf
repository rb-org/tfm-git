...
module "tfm_ecs" {
  ...
  repo_name        = "${var.name_prefix}-aws-mod-ecs"
  repo_description = "${var.desc_prefix} - Module ECS"
  license_template = "mit"
  private_repo     = false
  github_org       = "${var.github_organization}"
  team_count       = 1
...
module "tfm_github" {
  ...
  repo_name        = "${var.name_prefix}-aws-mod-github"
  repo_description = "${var.desc_prefix} - Module Github"
  license_template = "mit"
  private_repo     = false
  github_org       = "${var.github_organization}"
  team_count       = 1
